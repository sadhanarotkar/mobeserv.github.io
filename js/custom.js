$(function() {
    ...
    $('.clients-carousel').owlCarousel({
     ...
     // Clients owlCarousel
     $('.languages .owl-carousel').owlCarousel({
        loop: true, 
        margin: 30, 
        mouseDrag: true, 
        autoplay: true, 
...
$(".read-more").click(function(){
    ...
    $(".read-more > span").html().replace("Read Less", "Read Less"); 
})

$(document).ready(function () {
    $(".show_content").hide();
    $(".read-more").on("click", function () {
        var txt = $(".show_content").is(':visible') ? 'Read More' : 'Read Less';
        $(".read-more span").text(txt);
        $(this).prev('.show_content').slideToggle(200);
    });
});